...
export class QrCodeService {
     ...
     */
    async generateEmployeeQrCode(employeId, entrepriseId) {
     ...
     */
    async generatePointageQrCode(baseUrl, employeId, entrepriseId) {
     ...
     */
    async generateMultipleQrCodes(employeIds, entrepriseId) {
        const qrCodes = {};
