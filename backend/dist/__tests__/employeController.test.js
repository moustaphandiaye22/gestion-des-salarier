...
describe('EmployeController', () => {
    describe('GET /api/employes/export/template', () => {
        it('should return the employee template Excel file', async () => {
            ...
            ExportService.prototype.exportEmployeeTemplate.mockResolvedValue(mockBuffer);
        ...
        it('should handle errors gracefully', async () => {
            ExportService.prototype.exportEmployeeTemplate.mockRejectedValue(new Error('Export failed'));
            const response = await request(app)
                .get('/api/employes/export/template')
                .set('Authorization', 'Bearer testtoken')
                .expect(500);
...
//# sourceMappingURL=employeController.test.js.map