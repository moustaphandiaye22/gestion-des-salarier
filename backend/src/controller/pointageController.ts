...
export class PointageController {
  ...
  async getByEmploye(req: Request, res: Response) {
    try {
  ...
  async getByEmployeAndPeriode(req: Request, res: Response) {
    try {
      const employeId = Number(req.params.employeId);
      ...
      const pointages = await pointageService.getPointagesByEmployeAndPeriode(
        employeId,
  ...
  async getByEntrepriseAndDate(req: Request, res: Response) {
    try {
      ...
      const pointages = await pointageService.getPointagesByEntrepriseAndDate(
        entrepriseId,
        new Date(dateDebut as string),
        new Date(dateFin as string)
      );
  ...
  async pointerEntree(req: Request, res: Response) {
    try {
  ...
  async pointerSortie(req: Request, res: Response) {
    try {
  ...
  async calculateHeuresTravaillees(req: Request, res: Response) {
    try {
      const employeId = Number(req.params.employeId);
      const { dateDebut, dateFin } = req.query;
      ...
      const heures = await pointageService.calculateHeuresTravaillees(
        employeId,
        new Date(dateDebut as string),
        new Date(dateFin as string)
      );
  ...
  async getStatistiques(req: Request, res: Response) {
    try {
      ...
      const statistiques = await pointageService.getStatistiques(
        entrepriseId,
        new Date(dateDebut as string),
        new Date(dateFin as string)
      );
